                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                     Row(
                       children: [
                         IconButton(onPressed: (){Get.back();}, icon: Icon(Icons.keyboard_arrow_left_sharp,color: Colors.white,)),
                              ...
                              child: Container(
                                ...
                                child: Column(children: [
                                  Row(
                                    ...
                                    Row(
                                      children: [
                                        Text('${userProfielModel.data!.name}',style: TextStyle(color: Colors.black,fontSize:18),
                                          textScaleFactor:
                                          ScaleSize.textScaleFactor(
                                              context),
                                        ),
                                        ...
                                        children: [
                                          ...
                                          CircleAvatar(
                                              ...
                                              child: IconButton(onPressed: (){
                                                ...
                                                CacheHelper.saveData(key: 'emailuser', value: "${userProfielModel.data!.email}");
                                                CacheHelper.saveData(key: 'nameuser', value: "${userProfielModel.data!.name}");
                                                CacheHelper.saveData(key: 'imguser', value: "${userProfielModel.data!.profileImageFullUrl}");
                                                CacheHelper.saveData(key: 'iduser', value: userProfielModel.data!.id);
                                                CacheHelper.saveData(key: 'userUID', value: "${userProfielModel.data!.uid}");
                                                Get.to(()=> ChatScreen(),transition:Transition.rightToLeftWithFade,duration: Duration(milliseconds: 300) );
                                  ...
                                  controller.myfile != null
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () {
                                            controller.SendPhoto(context, userProfielModel.data!.id);
                                          },
                                          child: Icon(
                                            Icons.send,
                                            color: kPrimaryColor,
                                    ...
                                    children: [
                                      ...
                                      controller.FileSendded? Expanded(child: CircularProgressIndicator()):Expanded(
                                          child: IconButton(
                                              onPressed: () {
                                                controller.SendFile(context,userProfielModel.data!.id);
                                              },
                                              icon: Icon(
                                                Icons.send,
                                                color: kPrimaryColor,
                                                        ...
                                                        InkWell(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              Text('Camera',style: TextStyle(color:  Colors
                                                                  .white
                                                                  .withOpacity(
                                                        ...
                                                        InkWell(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              Text('Gallery',style: TextStyle(color:  Colors
                                                                  .white
                                                                  .withOpacity(
                                                                  0.5),fontWeight: FontWeight.w900), textScaleFactor:
                                                              ScaleSize
                                        ...
                                        Column(
                                          children: [
                                            CircleAvatar(
                                              ...
                                              child: InkWell(onTap: (){
                                                controller
                                                    .SendLocation(context,userProfielModel.data!.id);
                                              },
                                                child: controller.isSend?CircularProgressIndicator():SvgPicture.asset(
                                                  'assets/svg/ep_location.svg', // Ensure you have this SVG file in your assets directory
                                                ),
                                              ),
                                            ),
                                            Text('Location',textScaleFactor:
                                            ScaleSize.textScaleFactor(
                                                context),
                                            ),
                                          ],
                                  ...
                                  controller.latitude.isEmpty? Container():Center(
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Expanded(
                                          child: InkWell(onTap: (){
                                            controller.openLocation('https://www.google.com/maps/search/?api=1&query=${controller.latitude},${controller.longitude}');
                                          },child: Text('https://www.google.com/maps/search/?api=1&query=${controller.latitude},${controller.longitude}',style: TextStyle(color: Colors.blue),)),
                                        ),
                                        Expanded(
                                          child: InkWell(
                                            borderRadius: BorderRadius.circular(100),
                                            onTap: () {
                                              controller.SendLocatio(context, userProfielModel.data!.id);
                                            },
                                            child: Icon(
                                              Icons.send,
                                              color: kPrimaryColor,
